...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    name = models.CharField(max_length=100)
    Address=models.CharField(max_length=200,default="123 Main Street, Karachi")
    cnic=models.CharField(max_length=13,unique=True)
    contact=models.CharField(max_length=11,default="+123 (456) 789")
    emergency_contact=models.CharField(max_length=11,default="+123 (456) 789")
